...
do
    ...
    do
        mkdir -p exp_data/mnist/seed${SEEDS[$seed_idx]}/
        ...
        CUDA_VISIBLE_DEVICES=${GPUS[$gpu_idx]} python3 audit_model.py --data_name mnist_half --model_name cnn --n_epochs 100 --lr 1.33e-4 --epsilon ${EPS[$eps_idx]} \
            ...
            --seed ${SEEDS[$seed_idx]} --out exp_data/mnist_$TARGET_TYPE/seed${SEEDS[$seed_idx]}/ --block_size 10000 > exp_data/mnist/seed${SEEDS[$seed_idx]}/${EPS[$eps_idx]}.log 2>&1 &
    done
done